...
import com.calendar.core.draw.DayDrawDataProvider
import com.calendar.core.draw.DayDrawDelegate
import com.calendar.core.draw.DefaultDayDrawDataProvider
import com.calendar.core.draw.DefaultDayDrawDelegate
import com.calendar.core.format.*
import com.calendar.core.indicator.MonthIndicator
import com.calendar.core.indicator.pager.PagerIndicator
 ...
 *
 */
open class MaterialCalendarView @JvmOverloads constructor(
    context: Context,
    ...
    init {
        ...
        try {
            ...
            val tileSize = a.getLayoutDimension(
            ...
            val tileWidth = a.getLayoutDimension(
            ...
            val tileHeight = a.getLayoutDimension(
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        val viewTileHeight =
            if (monthIndicatorVisible) weekCount + monthIndicator.desiredHeightTileNumber() else weekCount
        ...
        for (i in 0 until count) {
            ...
            if (child == monthIndicatorView) {
                if (monthIndicator.getDesiredLayoutParamsWidth() == ViewGroup.LayoutParams.MATCH_PARENT)
                    child.measure(
                        View.MeasureSpec.makeMeasureSpec(specWidthSize, View.MeasureSpec.EXACTLY),
    ...
    class LayoutParams(tileHeight: Int) :
        ViewGroup.MarginLayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, tileHeight)
    ...
    private fun commit(state: State) {
        ...
        if (adapter != null && state.cacheCurrentPosition) {
            ...
            if (calendarMode !== state.calendarMode) {
                ...
                if (calendarMode === CalendarMode.MONTHS && currentlySelectedDate != null) {
                    ...
                    if (currentlySelectedDate == calendarDayToShow || currentlySelectedDate.isAfter(
                            calendarDayToShow
                    ...
                    val lastVisibleCalendarDay = CalendarDay.from(lastVisibleCalendar)
                    calendarDayToShow =
                        if (currentlySelectedDate != null && (currentlySelectedDate == calendarDayToShow || currentlySelectedDate == lastVisibleCalendarDay ||
        ...
        setCurrentDate(
            if (this.selectionMode == SELECTION_MODE_SINGLE && !adapter!!.getSelectedDates()
                    .isEmpty()
            )

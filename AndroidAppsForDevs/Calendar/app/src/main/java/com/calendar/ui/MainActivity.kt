...
class MainActivity : AppCompatActivity() {
    ...
    inner class ResolveInfoAdapter constructor(
        context: Context,
        private val samples: List<ResolveInfo>
        ...
        inner class ResolveInfoViewHolder(view: View) : RecyclerView.ViewHolder(view),

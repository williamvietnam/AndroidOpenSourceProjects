...
import com.calendar.core.format.DayFormatter
import com.calendar.core.format.WeekDayFormatter
...
abstract class CalendarPagerView(
    ...
    protected val firstDayOfWeek: Int
) : ViewGroup(mcv.context), View.OnClickListener {
    ...
    protected fun resetAndGetWorkingCalendar(): Calendar {
        ...
        val removeRow =
            if (MaterialCalendarView.showOtherMonths(showOtherDates)) delta >= 0 else delta > 0
        if (removeRow) {
